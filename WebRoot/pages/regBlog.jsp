...
%>
<style type="text/css">
body { background-image: url("images/1.jpg");background-size: 100% 1150px; background-repeat:no-repeat;}
</style>
<html>
	<head>
		<title>注册博客</title>
	...
	<body>
		<center>
    		...
    		<table border="1" width="1003" height="167" background="" bordercolor="#4E6900" bordercolordark="white" bordercolorlight="#4E6900" cellspacing="0" cellpadding="0" style="margin-top:1" rules="none">
