...
<html>
	...
	<body>
    	<center>
			...
			<table border="10" width="1003" height="167" background="images/allBack.jpg" bordercolor="#4E6900" style="margin-top:1;margin-bottom:1"><tr><td align="center">该文章目前没有任何评论哦！</td></tr></table>
			</c:if>
