...
<center>
    ...
    <c:if test="${!empty friend}">
        <table border="1" rules="none" width="1003" height="167" background="images/allBack.jpg" bordercolor="#4E6900" bordercolordark="white" bordercolorlight="#4E6900" cellspacing="0" cellpadding="0" style="margin-top:80">
            ...
            <c:if test="${!empty friend}">
                ...
                <tr height="40">
                    <td width="30%" align="right" style="padding-right:20">姓名：</td>
    ...
    <table border="0" width="1003" height="128" cellpadding="0" cellspacing="0"><tr><td background="images/allBack.jpg"></td></tr></table>
</center>
</body>
</html>